...
function searchVideo(){
    ...
    //https://www.youtube.com/watch?v=bIkoo4YgTAs

    let firstPart = userURL.slice(0, 24);

    let secondPart = userURL.slice(24,);

    let userTrueURL = firstPart + 'embed/' + secondPart;

    video.src = userTrueURL;
